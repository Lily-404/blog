    ...
    return (
      <div className="py-4">
        <Card variant="default" shadow={false} className="flex flex-col lg:flex-row overflow-hidden p-0 max-w-full">
          ...
          <div className="h-px lg:h-full lg:w-px bg-zinc-200 dark:bg-zinc-800 flex-shrink-0"></div>

          {/* 预览区域 */}
          <div className="flex-1 flex flex-col min-w-0">
            <div 
              ref={previewRef}
              className="px-5 py-4 bg-zinc-50 dark:bg-zinc-800/30 overflow-y-auto overflow-x-hidden flex-1 h-[300px] lg:h-[600px] min-h-[300px] lg:min-h-[600px] max-h-[300px] lg:max-h-[600px]"
            >
      ...
      <div className="py-4">
        <Card variant="default" shadow={false} className="p-0 max-w-full overflow-hidden">
          <textarea
            ...
            value={content}
            onChange={(e) => onContentChange(e.target.value)}
            className="w-full px-5 py-4 bg-transparent dark:bg-transparent text-sm dark:text-zinc-100 text-zinc-900 resize-none flex-1 overflow-y-auto overflow-x-hidden focus:outline-none focus:ring-0 focus:border-zinc-200 dark:focus:border-zinc-800 transition-all font-mono placeholder:text-zinc-400 dark:placeholder:text-zinc-600 border-0"
          style={{ 
            minHeight: "600px"
          }}
          required
  ...
  return (
    <div className="py-4">
      <Card variant="muted" shadow={false} className="p-0 max-w-full overflow-hidden">
        <div
          ref={previewRef}
          className="px-5 py-4 overflow-y-auto overflow-x-hidden flex-1"
          style={{ 
            minHeight: "600px"
          }}
        >
